...
// Read endpoints should be public; write/interaction remain auth-protected
PostRoutes.get("/story", PostsController.getAllStoriesActions);
PostRoutes.get("/user-story", PostsController.getStoriesOfUserByUserName);
...
PostRoutes.get("/tagged/:id", PostsController.getTaggedUsers);
