...
export class Server {
  ...
  regsiterRoutes() {
    ...
    this.app.use("/api/v1/documents", Auth, DocumentRoutes);
    this.app.use("/api/v1/interests", Auth, InterestRoutes);
    this.app.use("/api/v1/interaction", Auth, InteractionRoutes);
    this.app.use("/api/v1/plans", Auth, SubscriptionPlanRoutes);
    this.app.use("/api/v1/user-connections", Auth, ConnectionRoutes);
    this.app.use("/api/v1/payment", Auth, PaymentRoutes);
    this.app.use("/api/v1/stats", StatsRoutes);
    this.app.use("/api/v1/feature", Auth, FeatureRoutes);
    this.app.use("/api/v1/card-details", CardDetailsRoutes);
    this.app.use("/api/v1/subscriptions", Auth, SubscriptionRoutes);
    this.app.use("/api/v1/support", Auth, SupportRoutes);
    this.app.use("/api/v1/transactions", Auth, TransactionRoutes);
    this.app.use("/api/v1/notifications", Auth, NotificationRoutes);
    this.app.use("/api/v1/more-actions", Auth, moreActionRoutes);
    this.app.use("/api/v1/process-data", Auth, userDataRoutes);
